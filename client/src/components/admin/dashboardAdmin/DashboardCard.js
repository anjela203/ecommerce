  ...
  return (
    <Fragment>
      ...
      <div className="m-4 grid grid-cols-1 md:grid-cols-4 row-gap-4 col-gap-4">
        <div className="flex rounded-lg flex-col justify-center items-center col-span-1 bg-white p-6 shadow-lg border-b-4 border-indigo-400">
        ...
        <div className="flex rounded-lg flex-col justify-center items-center col-span-1 bg-white p-6 shadow-lg border-b-4 border-red-400">
        ...
        <div className="flex rounded-lg flex-col justify-center items-center col-span-1 bg-white p-6 shadow-lg border-b-4 border-green-400">
        ...
        <div className="flex rounded-lg flex-col justify-center items-center col-span-1 bg-white p-6 shadow-lg border-b-4 border-orange-400">
